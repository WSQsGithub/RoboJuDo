...
class G1VisualmimicPolicyCfg(VisualmimicPolicyCfg):
    ...
    # Direct file paths (no conversion step needed)
    tracker_model_path: str = (ASSETS_DIR / "models/g1/twist/twist_general_motion_tracker.pt").as_posix()
    generator_model_path: str = (ASSETS_DIR / "models/g1/visualmimic/pnp_generator.onnx").as_posix()
    train_config_file: str = (ASSETS_DIR / "models/g1/visualmimic/pnp_config.yaml").as_posix()
    ...
    # These are loaded dynamically from train_config_file in VisualmimicPolicy.
    # Keep minimal defaults here so pydantic/base class validation succeeds.
    ...
    # Let ONNX runtime auto-detect input names from model.
    policy_input_keys: list[str] = []
